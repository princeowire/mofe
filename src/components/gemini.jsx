...
const CVUploader = () => {
  ...
  // ✅ NEW handleSubmit without backend
  const handleSubmit = async () => {
    ...
    try {
      ...
      const base64CV = await toBase64(cvFile);
      ...
      // Create prompt
      const prompt = `
        You are a CV/job matcher AI.
        Compare the following CV (PDF or DOC text) with the job description.
        Give a short analysis of how well the candidate fits the role.
      ...
      const result = await model.generateContent([
        {
          inlineData: {
            data: base64CV,
            mimeType: cvFile.type, // e.g. "application/pdf"
          },
        },
        { text: prompt },
      ]);
